# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-07-20 15:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deviceId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='canvass.Device')),
                ('groupID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='canvass.Group')),
            ],
        ),
        migrations.CreateModel(
            name='Port',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('groupID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='canvass.Group')),
                ('userID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='canvass.User')),
            ],
        ),
        migrations.AddField(
            model_name='config',
            name='devID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='canvass.Device'),
        ),
        migrations.AddField(
            model_name='config',
            name='groupID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='canvass.Group'),
        ),
    ]
